...
class ReturnPackagePage extends StatefulWidget {
  @override
  _ReturnPackagePageState createState() => _ReturnPackagePageState();
}

class _ReturnPackagePageState extends State<ReturnPackagePage> {
              ...
              Visibility(
                ...
                child: Column(children: <Widget>[
                  new Padding(
                      ...
                      child: Text(
                        "Please upload photos of the item you recieved.",
                  ...
                  new Padding(
                    padding: const EdgeInsets.only(
                        top: 40.0, left: 15.0, right: 15.0, bottom: 30.0),
                    child: new Container(
    ...
    check().then((intenet) async {
      if (intenet != null && intenet) {
        ...
        if (isempty == false) {
          dynamic mybody = {
            'orderid': '$orderid',
            'returnifsc': '$returnifsc',
            'returnacno': '$returnacno',
          ...
          var stream1 =
              new http.ByteStream(DelegatingStream.typed(picture1.openRead()));
          var length1 = await picture1.length();
          int intex1 = picture1.path.lastIndexOf("/");
          String yourCuttedString1 =
              picture1.path.substring(intex1 + 1, picture1.path.length);
          print(yourCuttedString1);
          var multipartFile1 = new http.MultipartFile(
              'returnphoto', stream1, length1,
              filename: yourCuttedString1,
              contentType: new MediaType('image', 'png'));

          var stream2 =
              new http.ByteStream(DelegatingStream.typed(picture2.openRead()));
          var length2 = await picture2.length();
          int intex2 = picture2.path.lastIndexOf("/");
          String yourCuttedString2 =
              picture2.path.substring(intex2 + 1, picture2.path.length);
          print(yourCuttedString2);
          var multipartFile2 = new http.MultipartFile(
              'returnphoto', stream2, length2,
              filename: yourCuttedString2,
              contentType: new MediaType('image', 'png'));

          var stream3 =
              new http.ByteStream(DelegatingStream.typed(picture3.openRead()));
          var length3 = await picture3.length();
          int intex3 = picture3.path.lastIndexOf("/");
          String yourCuttedString3 =
              picture3.path.substring(intex3 + 1, picture3.path.length);
          print(yourCuttedString3);
          var multipartFile3 = new http.MultipartFile(
              'returnphoto', stream3, length3,
              filename: yourCuttedString3,
              contentType: new MediaType('image', 'png'));

          var stream4 =
              new http.ByteStream(DelegatingStream.typed(picture4.openRead()));
          var length4 = await picture4.length();
          int intex4 = picture4.path.lastIndexOf("/");
          String yourCuttedString4 =
              picture4.path.substring(intex4 + 1, picture4.path.length);
          print(yourCuttedString4);
          var multipartFile4 = new http.MultipartFile(
              'returnphoto', stream4, length4,
              filename: yourCuttedString4,
              contentType: new MediaType('image', 'png'));

          var url =
              Uri.parse("https://www.a2zonlineshoppy.com/api/returnpackage");
