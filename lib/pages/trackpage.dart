...
class _TrackPageState extends State<TrackPage> {
  ...
  Future<String> getJsonData() async {
    sharedPreferences = await SharedPreferences.getInstance();
    final String url =
        'https://www.a2zonlineshoppy.com/api/trackorder/$orderid/$index';
              ...
              children: <Widget>[
                  ...
                  child: new Container(
                      ...
                      child: new Padding(
                        ...
                        child: FittedBox(
                            fit: BoxFit.contain,
                            child: Text(
                              'Status : Cancelled on $cancelformatdate',
                              style: TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.bold),
                              textAlign: TextAlign.center,
                ...
                Visibility(
                  ...
                  child: Container(
                    ...
                    height: len == null ? 120.0 : (len * 120.0) + 100,
