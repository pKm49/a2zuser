...
import 'package:a2zonlinshoppy/components/singlebusinesscartproductview.dart';
...
class BusinessCart extends StatefulWidget {
  @override
  BusinessCartState createState() => BusinessCartState();
}

class BusinessCartState extends State<BusinessCart> {
  SharedPreferences sharedPreferences;
  Map<String, String> heaaders = {};
  String name;
  String mobile;
  int totalPrice = 0, totalQty = 0, totalbv = 0, len;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
          ...
          child: SingleBusinessCartProductView(),
        ),
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      Expanded(
                        flex: 1,
                        child: new Text(
                          "Cart Total ($totalQty items, $totalbv BV)  :  ₹$totalPrice",
                          style: TextStyle(
