...
class SingleBusinessCartProductView extends StatefulWidget {
  @override
  _SingleBusinessCartProductViewState createState() =>
      _SingleBusinessCartProductViewState();
}

class _SingleBusinessCartProductViewState
    extends State<SingleBusinessCartProductView> {
  BuildContext bcont;
  List data;
  ...
  Future<String> getJsonData() async {
    sharedPreferences = await SharedPreferences.getInstance();
    final String url = 'https://www.a2zonlineshoppy.com/api/businesscart';
...
class Single_products extends StatelessWidget {
  ...
  void remove(id, context) async {
    ...
    final String url =
        'https://www.a2zonlineshoppy.com/api/removebone?id=$id&size=$size';
    dynamic mybody = {'size': '$size', 'id': '$id', '_csrf': '$csrf'};
    ...
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (context) => BusinessCart()));
  }
  ...
  void changeqty(qy, context) async {
    ...
    final String url =
        'https://www.a2zonlineshoppy.com/api/changebqty?id=$id&size=$size&qty=$qy';
    dynamic mybody = {'size': '$size', 'id': '$id', '_csrf': '$csrf'};
