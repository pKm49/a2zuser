...
class _HomeCategoriesState extends State<HomeCategories> {
  ...
  String name;
  String mobile;
  String productId,homecategories;
  ...
  Future<String> getJsonData() async{
    ...
    homecategories = sharedPreferences.getString('homecategories');
    ...
    if(homecategories == null){
      ...
      check().then((intenet) async{
        if (intenet != null && intenet) {
          ...
          homecategories = json.encode(tempdata);
          sharedPreferences.setString('homecategories', homecategories);

          setState(() {
            data = tempdata;
            len =3;
            hght = (MediaQuery.of(context).size.width*1);
      ...
      setState(() {
        data = json.decode(homecategories);
        len =3;
        hght = (MediaQuery.of(context).size.width*1);
  ...
  Widget build(BuildContext context) {
    ...
    return Visibility(
      ...
      child: Container(
        ...
        child: Padding(padding: const EdgeInsets.all(10.0),child:new StaggeredGridView.countBuilder(
          ...
          new StaggeredTile.count(index==0?4:1,1),
          mainAxisSpacing: 5.0,
    ...
    return    Card(
        child:new InkWell(
          ...
          child: Container(
            ...
            child:Padding(padding: const EdgeInsets.only(left:10.0,bottom:5.0),child:
